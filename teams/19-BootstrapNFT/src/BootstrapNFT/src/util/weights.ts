...
export function getMaxTotalWeight(isSharedOrLockedSmartPool: boolean) {
...
export function getDivisor(isSharedOrLockedSmartPool: boolean) {
...
export function getMaxPercentage(isSharedOrLockedSmartPool: boolean) {
...
export function getDenorm(percentage: any, isSharedOrLockedSmartPool: boolean) {
...
export function isValidDenormValue(denorm: number) {
